...
A laboratory-intelligence layer has to remember more than a normal application log.
A future decision may depend
...
class EvidenceLedger:
  ...
  refuses to append to a ledger that diverges from this instance's verified snapshot.
