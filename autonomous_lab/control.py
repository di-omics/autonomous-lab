...
one invariant, and the invariant is the reason the rest of it is safe to have.
  ...
  surrogate over assay parameters. Both are Bayesian and both report their own uncertainty,
...
class Controller:
  """A supervisory controller over assay parameters.
  ...
  def propose(self, observations: Sequence[Observation], candidates: int = 800):
    ...
    would be reporting the shape of its kernel rather than the shape of the assay.
    """
