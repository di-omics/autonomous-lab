...
and the lab has to keep running:
  ...
  imitation     from a captured demonstration to a policy that may be trusted with
                material. A video is not a demonstration, the fixture is inside what the
                policy learned, and a properly run evaluation is not a good result.
