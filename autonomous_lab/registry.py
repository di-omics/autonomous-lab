  ...
  "star": FederatedSpec(
    ...
    validated_ops={
      "pta_wga_lysis": ValidatedRun(
        script="liquid-handler/starlab_live/00_pta_wga_1col_src1lysis_src3rxn_dst1_hhs_DRY.py",
      ...
      "pcr_enrichment_choreography": ValidatedRun(
        script="liquid-handler/starlab_live/run_pcr_enrichment_odtc_LIDDED_1col_full_thermocycle.py",
